...
$(BUILD_DIR)/kernel.bin:
	...
	$(CXX) -e main -ffreestanding -m32 -nostdlib -no-pie -o $(BUILD_DIR)/kernel.o $(wildcard $(SRC_DIR)/kernel/*.cpp) $(wildcard $(SRC_DIR)/kernel/*.c) $(wildcard $(SRC_DIR)/kernel/*/*.cpp) $(wildcard $(SRC_DIR)/kernel/*/*.c) 
